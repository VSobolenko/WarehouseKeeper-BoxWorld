...
public class BinaryFileRepositorySystemTests
{
    ...
    private const string TestFolder = "d2b6a6a6-BinaryTestedFiles-26d1-4972-ad92-83da8f927cff";

    private SimpleTestClass ReadableClass => new SimpleTestClass {id = 7, name = "Player", };
    ...
    {
        // Arrange
        IFileRepository fileRepository = new BinaryFileRepositorySystem();
        
        // Act
        var data = fileRepository.Read<SimpleTestClass>(_pathToReadFile);
    ...
    public void Deserialize_JsonString_ShouldReturnNewClassWithData()
    {
        ...
        // Act
        var deserializableClass = fileRepository.Deserialize<SimpleTestClass>(serializeBytesData);
