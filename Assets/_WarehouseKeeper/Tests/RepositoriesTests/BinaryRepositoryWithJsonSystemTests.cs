...
public class BinaryRepositoryWithJsonSystemTests
{
    ...
    private const string TestFolder = "d2b6a6a6-BinaryWithJsonTestedFiles-26d1-4972-ad92-83da8f927cff";
    ...
    {
        var jsonString = new JsonFileRepositorySystem().Serialize(obj);
    ...
    {
        // Arrange
        IFileRepository fileRepository = new BinaryRepositoryWithJsonSystem(new JsonFileRepositorySystem());
