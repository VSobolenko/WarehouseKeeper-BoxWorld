...
namespace WarehouseKeeper.Repositories.Implementation
{
public class ResourcesRepositoryManager<T> : BaseRepositoryManager<T>, IRepository<T> where T : Object, IHasBasicId
{
