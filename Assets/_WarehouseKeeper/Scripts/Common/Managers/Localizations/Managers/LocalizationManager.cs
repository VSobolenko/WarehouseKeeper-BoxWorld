...
using WarehouseKeeper.Repositories.PreferencesSaveType;

namespace WarehouseKeeper.Localizations.Managers
{
internal class LocalizationManager : ILocalizationManager
{
    private readonly LocalizationSettings _settings;
    private readonly Dictionary<string, List<string>> _localization = new Dictionary<string, List<string>>(15);
